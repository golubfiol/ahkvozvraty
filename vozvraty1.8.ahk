...
Gui, Add, Text, x15 y67  w370, Ctrl + Numpad4 - 47
Gui, Add, Text, x15 y89  w370, Ctrl + Numpad5 - Поиск по клиентскому
Gui, Add, Text, x15 y111 w370, Ctrl + Numpad7 - Поздний возврат 9
Gui, Add, Text, x15 y133 w370, Ctrl + Numpad8 - Поздний возврат 18
Gui, Add, Text, x15 y155 w370, Ctrl + Numpad9 - Поздний возврат 27
Gui, Add, Text, x15 y177 w370, Ctrl + Numpad0 - Изменить клиентский номер
Gui, Add, Text, x15 y199 w370, Insert - Скрыть/Показать
Gui, Add, Text, x15 y221 w370, Ctrl + Numpad+ - Продолжить задачу
Gui, Add, Text, x15 y243 w370, Ctrl + Numpad- - Сброс

Gui, Font, s11 cWhite Bold, Segoe UI
Gui, Add, Text, x15 y279 w370 cLime, === СТАТУС ===
Gui, Font, s10 cYellow Norm
Gui, Add, Text, x15 y304 w370 vStatusText, Готов

Gui, Show, x0 y300 w400 h345 NoActivate, Overlay
...
UpdateOverlayPosition() {
    ...
    posX := ScreenW - 420
    posY := (ScreenH - 345) // 2
    Gui, Show, x%posX% y%posY% w400 h345 NoActivate, Overlay
}
