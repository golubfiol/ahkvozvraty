...
Gui, Add, Text, x15 y199 w370, Ctrl + Numpad+ - Продолжить задачу
Gui, Add, Text, x15 y221 w370, Ctrl + Numpad- - Сброс
Gui, Add, Text, x15 y243 w370, Insert - Скрыть/Показать
Gui, Add, Text, x15 y265 w370, End - Закрыть ахк
