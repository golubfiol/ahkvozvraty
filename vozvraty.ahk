...
CheckForUpdates() {
    ...
    ; Жёсткая очистка: только цифры и точки
...
global SearchNumber  := "66811"   ; для Numpad5 - Поиск по клиентскому
global SearchNumber1 := "86958"   ; для Numpad1 - Товар с реализации 1
...
; ============================================
^Numpad0::
    MsgBox, 3, Изменить число, Да - Поиск по клиентскому (Numpad5)`nНет - Товар с реализации 1 (Numpad1)`n`nОтмена - выход
    IfMsgBox, Yes
    {
