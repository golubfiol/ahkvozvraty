...
BuildOverlay() {
    ...
    ; Показываем окно в левом верхнем углу, чтобы получить его реальные размеры
    Gui, Main:Show, x0 y0 w%winW% h%winH% NoActivate, Overlay
    Sleep, 30

    ; Теперь считаем позицию и сдвигаем вправо-по центру
    SysGet, ScreenW, 0
    SysGet, ScreenH, 1
...
; ============================================
; Ctrl + Numpad1 — зависит от профиля
; ============================================
^Numpad1::
    if (Profile = "Дека") {
        SetKeyDelay, 30, 20
